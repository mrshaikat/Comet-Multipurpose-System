					...
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">All Products
								<a class="btn btn-primary btn-sm pull-right" href="{{ route('product.create') }}"><i class="fas fa-plus mr-1"></i> Create Product</a>
							</h4>

						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table id="product_table" class="table table-striped mb-0">
									<thead>
										<tr>
											<th>SL</th>
											<th>Product Name</th>
